...
| Figure | Twin | What it measures | Repo |
|---|---|---|---|
| Thor | AeroTwin | 400 Hz edge policy, held-out sim-to-real gap | [aerotwin](https://github.com/beastlyluck/aerotwin) |
| Batman | GridPulse | Dispatch LP against a physics-informed line rating | [gridpulse](https://github.com/beastlyluck/gridpulse) |
| Iron Man | BioSync | On-device RK4 wearable replica, DP cohort | [biosync](https://github.com/beastlyluck/biosync) |
| Luffy | OceanicOS | Port assignment matrix that keeps the yard clear | [oceanicos](https://github.com/beastlyluck/oceanicos) |
